...
/*   Updated: 2024/09/10 15:27:27 by pmarkaid         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "minishell.h"

static int	var_in_env(char *argv, char **env, int ij[2])
{
	int	pos;
...
static void	ft_export_do(t_macro *macro, char *name, char *value)
{
	int		ij[2];
	int		pos;
	char	*cmd;
